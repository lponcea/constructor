...
import { AsignaturaComponent } from 'app/entities/asignatura/asignatura.component';
...
describe('Component Tests', () => {
  describe('Asignatura Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.asignaturas && comp.asignaturas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
